...
public class MyBatisTest {
	 ...
	 * 		解析文件的每一个信息保存在Configuration中，返回包含Configuration的 DefaultSqlSessionFactory；
	 * 		注意：【MappedStatement】：代表一个增删改查的详细信息
	 * 
	 * 2、获取sqlSession对象
	 *		new DefaultSqlSession(this.configuration, executor, autoCommit);
	 * 		返回一个 DefaultSqlSession 对象，包含 Configuration 和 Executor;
	 * 		这一步会创建Executor对象；
	 * 
